    ...
    <>
        ...
        <form id="party-form" onSubmit={submit} className="space-y-5">
          ...
          <div className="flex justify-end gap-3">
            ...
            <Button type="submit" loading={loading}>
              {editing ? "Update Party" : "Submit Party"}
            </Button>
          </div>
        </form>
      </Card>
      ...
      <DataTable
        columns={
          isAdmin
            ? columns
            : columns.filter((column) => column.key !== "sales_profit")
        }
        rows={paginatedItems}
        rowKey={(row) => row.id}
        actions={actions}
            ...
            <table className="w-full text-sm">
              <tbody className="divide-y divide-border-gold">
                ...
                <tr>
                  ...
                  <td className="px-4 py-2 text-secondary">{viewing.mobile}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2 font-semibold text-text-secondary">
                    Email
                ...
                <tr>
                  ...
                  <td className="px-4 py-2 text-secondary">{viewing.city}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2 font-semibold text-text-secondary">
                    State
                  </td>
                  <td className="px-4 py-2 text-secondary">{viewing.state}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2 font-semibold text-text-secondary">
                    Country
